...
namespace Microsoft.Extensions.FileSystemGlobbing.Abstractions
{
    ...
    public abstract class DirectoryInfoBase : FileSystemInfoBase
    {
        ...
        public abstract IEnumerable<FileSystemInfoBase> EnumerableFileSystemInfos();

        /// <summary>
        /// Return an instance of <see cref="DirectoryInfoBase"/> that represents a subdirectory.
        /// </summary>
