...
namespace Microsoft.Extensions.FileProviders.Physical
{
    ...
    /// from false to true and dispose the token after this happens.
    /// </para>
    /// </summary>
    /// <remarks>
    ...
    public class PollingFileChangeToken : IPollingChangeToken
    {
        ...
        private DateTime _lastCheckoutedTimeUtc;
        private bool _hasChanged;
        private CancellationTokenSource _tokenSource;
        private CancellationChangeToken _changeToken;

        /// <summary>
        /// Initializes a new instance of <see cref="PollingFileChangeToken"/> that polls the specified file for change as
        ...
        /// <summary>
        /// True when the file has changed since the change token was created. Once the file chagnes,this value is always true.
        /// </summary>
        ///<remarks>
        ///Once true, the value will always be true. Change tokens should not re-used once expired. 
        /// The caller should discard this instance once it sees <see cref="HasChanged"/> is true.
        ///</remarks>
        public bool HasChanged
        {
            get
            {
                ...
                if(currentTime - _lastCheckoutedTimeUtc < PollingInterval)
                {
                    return _hasChanged;
                }
                ...
                _lastCheckoutedTimeUtc = currentTime;
                return _hasChanged;
            }
        }
